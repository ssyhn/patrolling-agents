# patrolling-agents
Small game containing simple patrolling and navigational AI logic, made in Godot Game Engine.

## Functionality
There exist two types of agents: 
- "Regular" agents (blue): will move to a given point on the map;
- "Patroller" agents (red): will move between two given points on the map.
